...
### Bienenhaus
![Bienenhaus](./basiskurs1-data/Bienenhaus.jpg)<!-- .element class="r-strech " -->
...
### Freistand
![Freistand](./basiskurs1-data/freistand.jpg)<!-- .element class="r-strech"  -->
...
### Freiaufstellung
![Freiaufstellung](./basiskurs1-data/freiaufstellung.png)<!-- .element class="r-strech"  -->

--

### Freiaufstellung
#### Einzelaufstellung
![Freiaufstellung](./basiskurs1-data/freiaufstellung1.png)<!-- .element class="r-strech" width="15%" -->
* Hoher Platzbedarf
...
### Freiaufstellung
#### Zweieraufstellung
![Freiaufstellung](./basiskurs1-data/freiaufstellung2.png)<!-- .element class="r-strech" width="15%" -->
* Seitliches Arbeiten möglich
* Kippen möglich
...
### Freiaufstellung
#### 4er Block
![Freiaufstellung](./basiskurs1-data/freiaufstellung3.png)<!-- .element class="r-strech" width="15%" -->
* Seitliches Arbeiten möglich
* geringer Verflug
...
### Freiaufstellung
#### Reihenaufstellung
![Freiaufstellung](./basiskurs1-data/freiaufstellung4.png)<!-- .element class="r-strech" width="15%" -->
...
![Krankheiten](./basiskurs1-data/krankheiten.png)<!-- .element class="r-strech"  -->
...
![Eine Stockkarte](./basiskurs1-data/Stockkarte.jpg)<!-- .element class="r-strech" width="35%" -->
